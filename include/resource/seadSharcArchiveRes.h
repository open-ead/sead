...
public:
    ...
    const void* getFileFastImpl_(s32 entry_id, FileInfo* file_info) SEAD_ARCHIVERES_CONST_TOKEN override;
#if SEAD_ARCHIVERES_TRYGETFILEPATH
    bool tryGetFilePathImpl_(SafeString* out_file_path, s32 entry_id) SEAD_ARCHIVERES_CONST_TOKEN override;
#endif
    ...
    bool openDirectoryImpl_(HandleBuffer* handle, const SafeString& path) SEAD_ARCHIVERES_CONST_TOKEN override;
    bool closeDirectoryImpl_(HandleBuffer* handle) SEAD_ARCHIVERES_CONST_TOKEN override;
    u32 readDirectoryImpl_(HandleBuffer* handle, DirectoryEntry* entry, u32 num) SEAD_ARCHIVERES_CONST_TOKEN override;
