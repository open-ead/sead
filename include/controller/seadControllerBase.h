...
public:
    ...
    const sead::BitFlag32 getButtonsTrigger() const { return mButtonsTrigger; }
    const sead::BitFlag32 getButtonsRelease() const { return mButtonsRelease; }
    const sead::BitFlag32 getButtonsRepeat() const { return mButtonsRepeat; }
    const sead::BitFlag32 getButtonsHold() const { return mButtonsHold; }
...
private:
    sead::BitFlag32 mButtonsTrigger;
    sead::BitFlag32 mButtonsRelease;
    sead::BitFlag32 mButtonsRepeat;
    unsigned int mFlags;
    int _18;
    int _1c;
