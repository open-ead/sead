...
#if SEAD_VERSION == SEAD_VERSION_BOTW or SEAD_VERSION == SEAD_VERSION_SMO
...
#elif SEAD_VERSION == SEAD_VERSION_SPL3 or SEAD_VERSION == SEAD_VERSION_TOTK or SEAD_VERSION == SEAD_VERSION_SMBW
