...
public:
    ...
    virtual bool openDirectoryImpl_(
        u32* handle,
        const SafeString&) = 0;  // openDirectoryImpl_(SafeArray<u8, 32>*, const SafeString&)
    virtual bool closeDirectoryImpl_(u32* handle) = 0;  // closeDirectoryImpl_(SafeArray<u8, 32>*)
    virtual u32 readDirectoryImpl_(
        u32* handle, DirectoryEntry* entry,
        u32 num) = 0;  // readDirectoryImpl_(SafeArray<u8, 32>*, DirectoryEntry*, u32)
